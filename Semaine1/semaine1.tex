...
\begin{questions}
\item Soit $A$ une partie de $\N$ contenant $0$ de densité au moins $0,5$. Montrer que tout naturel s'écrit comme somme de deux éléments de $A$.
\item $0\in A$ est-il une condition nécessaire, et "à quel point" ?
\item Soient $A,B \subset N$ contenant toutes deux $0$. On pose $A+B=\set{a+b, a\in A, b\in B}$. Montrer que $1-d(A+B)\le (1-d(A))(1-d(B))$.
\end{questions}
\end{exercise}
